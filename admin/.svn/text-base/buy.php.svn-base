    ...
    <div id="upthemes_framework">
        ...
        <div id="up_header" class="polish">
            ...
            <ul id="up_topnav">
                ...
                <li class="buy-themes current"><a href="<?php bloginfo('wpurl');?>/wp-admin/admin.php?page=upthemes-buy">Buy Themes</a></li>
            </ul><!-- /#up_topnav -->
        ...
        <div id="up_buy">
            <iframe src="http://www.upthemes.com/buy-themes/" frameborder="0"></iframe>
        </div>
    </div>
