    ...
    <div id="upthemes_framework">
		...
		<li class="documentation current"><a href="<?php bloginfo('wpurl');?>/wp-admin/admin.php?page=upthemes-docs">Theme Documentation</a></li>
	...
	<div class="button-zone-wrapper" style="display:none;">
	    ...
	    <?php
	    $ch = curl_init();
	    curl_setopt($ch, CURLOPT_URL, get_bloginfo('stylesheet_directory')."/readme.html");
